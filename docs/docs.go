                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReqAiChai"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ResAiChat"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ResSBTClaimInfo"
                        }
                    }
                }
            }
        },
        "/stpdao/v2/sbt/claim/list": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ResSBTClaimList"
                        }
                    }
                }
            }
        },
        "/stpdao/v2/sbt/create": {
            "post": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/models.ReqSBTCreate"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ResSBTDetail"
                        }
                    }
                }
            }
        ...
        "/stpdao/v2/sbt/list": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "status:soon;active;ended",
                        "name": "status",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/models.ResSBTList"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "models.ReqSBTCreate": {
            ...
            "properties": {
                ...
                "way": {
                    "description": "anyone;joined;whitelist",
                    "type": "string"
                },
                "whitelist": {
                    "$ref": "#/definitions/models.JsonWhitelist"
                }
            }
        },
