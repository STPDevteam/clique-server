...
CREATE TABLE `tb_task` (
    ...
    `priority` VARCHAR(20) NOT NULL DEFAULT '' COMMENT 'A_low;B_medium;C_high',
    `assign_account` VARCHAR(128) NOT NULL DEFAULT '',
    `proposal_id` INT NOT NULL DEFAULT 0,
    `reward` DECIMAL(65,0) UNSIGNED NOT NULL DEFAULT '0',
    `status` VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'A_notStarted;B_inProgress;C_done;D_notStatus',
