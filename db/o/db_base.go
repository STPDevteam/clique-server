...
//func SelectTbEventData(w ...[][]interface{}) (data []TbEventData, err error) {
//	err = oo.SqlSelect(o.DBPre(consts.TbEventData, w).Select(), &data)
//	return data, err
//}
//
//func GetTbEventData(w ...[][]interface{}) (data TbEventData, err error) {
//	err = oo.SqlGet(o.DBPre(consts.TbEventData, w).Select(), &data)
//	return data, err
//}
//
...
//}
//
//func Pagination(table, order string, page ReqPagination, data []TbEventData, w ...[][]interface{}) (list []Lists, total int64, err error) {
//	sqler := DBPre(table, w)
//	sqlCopy := *sqler
